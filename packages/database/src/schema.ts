import { pgTable, serial, text, timestamp, integer, doublePrecision, uuid, boolean, index } from 'drizzle-orm/pg-core';
import { relations, sql } from 'drizzle-orm';

// --- CORE (Użytkownicy i Organizacje) ---
...
export const weightMeasurements = pgTable('weight_measurements', {
  ...
  scaleId: uuid('scale_id').references(() => scales.id).notNull(),
